...
export function Dashboard({
  ...
  const chartData = useMemo(() => {
    const monthlyTotals = balances.reduce(
      (acc, b) => {
        const rawMonth =
          b.month && typeof b.month === "string" ? b.month : "2025-01-01";
  ...
  const percentageAchieved =
    targetAmount > 0 ? (currentTotal / targetAmount) * 100 : 0;
        ...
        <div className="glass-card flex items-center gap-6 p-6 w-full">
          ...
          <div className="flex-1 min-w-0">
            ...
            <h3 className="text-2xl font-black text-white uppercase">
              {new Date(targetDate + "T00:00:00").toLocaleDateString("es", {
                month: "short",
                year: "numeric",
              })}
            </h3>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-10">
          <div>
            ...
            <p className="text-zinc-400 mt-1">
              Comparativa vs Meta de ${targetAmount / 1000}k
            </p>
          </div>
            ...
            <ResponsiveContainer width="100%" height={400}>
              ...
              >
                ...
                <XAxis
                  ...
                  tickFormatter={(val) => {
                    try {
                      return new Date(val + "-01T00:00:00")
                ...
                <YAxis
                  ...
                  domain={[
                    0,
                    (dataMax: number) => Math.max(dataMax, targetAmount) * 1.2,
                  ]}
                />
                <Tooltip
                  contentStyle={{
